...
class BuildWritePrefetchDataProcessorTest {
  ...
  @Test def testArrayChoiceSeparatorSchemaMatchesSinglePass(): Unit = {
    ...
    val infoset =
      <ex:row xmlns:ex={
        example
      }><header>H</header><item>a</item><item>b</item><item>c</item><typeB>X</typeB></ex:row>
  ...
  @Test def testTrailingArrayPostfixSeparatorMatchesSinglePass(): Unit = {
    ...
    val infoset =
      <ex:row xmlns:ex={example}><item>a</item><item>b</item><item>c</item></ex:row>
  ...
  @Test def testChoiceBranchWithPresentOptionalElementMatchesSinglePass(): Unit = {
    ...
    val infoset = <ex:e1 xmlns:ex={example}><opt>0</opt><after>1</after></ex:e1>
  ...
  @Test def testManyOccurrenceArrayWithSmallPrefetchLimitMatchesSinglePass(): Unit = {
    ...
    val infoset = <ex:row xmlns:ex={example}>{items}</ex:row>
  ...
  @Test def testNestedBareSequenceMatchesSinglePass(): Unit = {
    ...
    val infoset =
      <ex:row xmlns:ex={
        example
      }><before>B</before><inner1>I1</inner1><inner2>I2</inner2><after>A</after></ex:row>
  ...
  @Test def testInitiatorTerminatorMatchesSinglePass(): Unit = {
    ...
    val infoset = <ex:row xmlns:ex={example}><a>A</a><b>B</b></ex:row>
  ...
  @Test def testEscapeSchemeMatchesSinglePass(): Unit = {
    ...
    val infoset = <ex:row xmlns:ex={example}><s1>one, two</s1><s2>three</s2></ex:row>
  ...
  @Test def testLayeredSequenceMatchesSinglePass(): Unit = {
    ...
    val infoset = <ex:e1 xmlns:ex={example}><s1>ABCDEFGH</s1><after>Q</after></ex:e1>
  ...
  @Test def testLayeredSequenceLengthMismatchErrorMatchesSinglePass(): Unit = {
    ...
    val infoset = <ex:e1 xmlns:ex={example}><s1>ABCDEFGHIJ</s1><after>Q</after></ex:e1>
  ...
  @Test def testBinaryIntArrayMatchesSinglePass(): Unit = {
    ...
    val infoset =
      <ex:row xmlns:ex={example}><item>1</item><item>2</item><item>3</item></ex:row>
  ...
  @Test def testVariableLengthExpressionMatchesSinglePass(): Unit = {
    ...
    val infoset = <ex:row xmlns:ex={
      example
    }><lenField>5</lenField><content>hello</content></ex:row>
  ...
  @Test def testPrefixedLengthComplexContentMatchesSinglePass(): Unit = {
    ...
    val infoset = <ex:row2 xmlns:ex={example}><body><a>hi</a><b>bye</b></body></ex:row2>
  ...
  @Test def testOVCCountOfPrecedingArrayMatchesSinglePass(): Unit = {
    ...
    val infoset = <ex:row xmlns:ex={example}><items>1</items><items>2</items></ex:row>
  ...
  @Test def testIVCExistsOverNestedArrayMatchesSinglePass(): Unit = {
    ...
    val infoset =
      <ex:row xmlns:ex={example}>
        <seq><item>1</item><item>2</item><item>3</item><item>4</item></seq>
        <exists>true</exists>
      </ex:row>
  ...
  @Test def testNVIScopedVariableWithValueLengthOVCMatchesSinglePass(): Unit = {
    ...
    val records =
      (0 until numRecords).map(i =>
        <record><idx>{f"$i%02d"}</idx><data>{s"value$i"}</data></record>
      )
    val infoset = <ex:root xmlns:ex={example}>{records}</ex:root>
  ...
  @Test def testSingleNVIScopedVariableWithValueLengthOVCMatchesSinglePass(): Unit = {
    ...
    val infoset = <ex:row xmlns:ex={example}><idx>42</idx><data>hello</data></ex:row>
  ...
  @Test def testDelimitedComplexVariableLengthExpressionMatchesSinglePass(): Unit = {
    ...
    val infoset = <ex:row xmlns:ex={
      example
    }><lenField>3</lenField><wrapper><a>xyz</a></wrapper></ex:row>
  ...
  @Test def testMixedSchemaWithResolvableAndContentLengthOVCStillUsesPrefetchPath(): Unit = {
    ...
    val infoset = <ex:row xmlns:ex={example}><actual>005</actual><data>xyz</data></ex:row>
